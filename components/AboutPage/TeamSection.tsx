...
function TeamMemberCard({
  ...
  return (
    <div className="group rounded-2xl border border-[#E2E8F0] bg-[#FFFFFF] p-6 shadow-sm transition-all duration-300 hover:shadow-md">
      ...
      <p className="mb-4 text-sm leading-relaxed text-[#475569]">{description}</p>

      <div className="flex space-x-3">
        <a href={social.linkedin} className="text-[#475569] transition-colors hover:text-[#14B8A6]">
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
          </svg>
        </a>
        <a href={social.twitter} className="text-[#475569] transition-colors hover:text-[#14B8A6]">
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <section className="bg-[#F8F9F5] py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-16 text-center">
          <h2 className="mb-6 text-3xl font-bold text-[#0F172A] md:text-4xl">Leadership Team</h2>
          <p className="mx-auto max-w-3xl text-base text-[#475569] md:text-lg">
            The people responsible for strategy, delivery, and operations at Concore Technologies.
          </p>
        </div>
