...
const TeamSection = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      description: "Creative mind focused on user experience excellence",
      social: { linkedin: "#", twitter: "#" }
    },
    {
      name: "David Thompson",
      ...
      description: "Full-stack expert with a passion for clean code",
      social: { linkedin: "#", twitter: "#" }
    },
    {
      name: "Lisa Wang",
    ...
    },
    {
      ...
      image: "/about/team/alex-kumar.jpg",
      description: "Infrastructure specialist ensuring seamless deployments",
      social: { linkedin: "#", twitter: "#" }
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            The brilliant minds behind our success. We're a diverse team of innovators, 
            creators, and problem-solvers united by our passion for technology.
          </p>
        </div>
